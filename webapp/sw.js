...
const CACHE = 'atom-v104';
const ASSETS = ['./','./index.html','./styles.css','./i18n.js','./i18n_tr.js','./mockdata.js','./growth_standard.js','./xlsx_min.js','./engine.js','./api.js','./app.js','./assets/logo.png','./assets/logo-icon.png','./assets/logo-maskable.png','./manifest.json'];
